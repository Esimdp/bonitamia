...
if(substr(basename($_SERVER['PHP_SELF']), 0, 11) == "imEmailForm") {
	...
	if(@$_POST['action'] != 'check_answer') {
		if(!isset($_POST['imJsCheck']) || $_POST['imJsCheck'] != 'D433170D9874F88DA7637F84C8D20BA8' || (isset($_POST['imSpProt']) && $_POST['imSpProt'] != ""))
			die(imPrintJsError());
		$form->mailToOwner('bonitamiamoda@gmail.com', 'bonitamiamoda@gmail.com', 'consulta web', 'Gracias por enviarnos tu consulta, a la brevedad nos estaremos comunicando contigo.', false);
